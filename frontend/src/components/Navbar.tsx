...
const navItems = [
  ...
  { path: '/kitchen', i18nKey: 'nav.kitchen', icon: 'M6 2h12a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2zm0 10h12M9 6v2M9 15v2' },
  ...
  { path: '/calendar', i18nKey: 'nav.calendar', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
];
