...
export default function Kitchen() {
  ...
  // Open scanner if navigated with state
  useEffect(() => {
    if ((location.state as any)?.openScanner) {
      setShowScanner(true);
    }
  }, [location.state]);
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-sm font-medium min-h-[44px]"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2.5 bg-amber-500 dark:bg-amber-600 text-white rounded-xl hover:bg-amber-600 dark:hover:bg-amber-700 transition-colors text-sm font-semibold shadow-sm min-h-[44px]"
          ...
          >
            ...
            <span className="hidden sm:inline">{t('barcode.scan')}</span>
          </button>
          <button
